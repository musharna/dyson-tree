...
- **Q2b** registered a prediction that was falsified. **The falsification itself is not
  affected by this note** ⚠️ *scoped → true for the **algal** class only; retiring
  Gate B readmits vascular, where carbon binds at Ω = 25, 30 (see the banner above and
  `docs/FINDINGS.md`)* — it compared the thermal floor against the carbon crossing, both
